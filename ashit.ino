...
#define baseMotorSpeed  90 //changed this from 70-95-110
...
void readSensors()
{
  ...
  int colour1=digitalRead(sensors[0]);
  int colour2=digitalRead(sensors[7]);
  int background =(colour1 ^ colour2);
  if (background ==0)
  {
    state =( colour1 &&colour2);
